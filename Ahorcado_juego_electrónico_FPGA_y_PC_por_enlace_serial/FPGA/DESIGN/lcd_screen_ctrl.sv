// =====================================================================
// lcd_screen_ctrl.sv - Capa de presentacion del LCD (version modular)
//
...
//
// El PUERTO de este modulo es identico al de la version anterior: no
// cambia nada de cara a top, que es quien lo instancia. Lo que cambia es
// la implementacion interna, que ahora se apoya en tres bloques mas
// pequenos:
...
//
// Este archivo conserva solo la maquina de estados que dialoga con
// lcd_peripheral (el "maestro del bus"):
...
module lcd_screen_ctrl #(
    ...
    // orden de dibujo
    input  logic [2:0]  screen_i,     // ver codigos en lcd_screen_pkg
